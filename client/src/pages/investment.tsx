...
import { RefreshCw, ChevronDown, ArrowLeft, BookOpen, TrendingUp, MoreHorizontal, Lock, ArrowRight } from "lucide-react";
import { apiRequest } from "@/lib/queryClient";
import GLOBE from "vanta/dist/vanta.globe.min";
import * as THREE from "three";
import { motion } from "framer-motion";

// Placeholder for FluxLogoHeader component if it exists elsewhere
// If it's not defined, you might need to create it or replace this with a simple text logo.
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
          ...
          <div className="bg-[#1A1A1A]/80 backdrop-blur-xl rounded-2xl p-8 border-2 border-[#00FF80]/30 text-center"
            ...
            <div className="mb-6 mt-8">
              ...
              <p className="text-lg text-gray-300 mb-2">Please log in to access investments</p>
            </div>
